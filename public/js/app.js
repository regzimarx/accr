...
window.addEventListener("file_requested", function (event) {
...
window.addEventListener("request_exists", function (event) {
  node_snackbar__WEBPACK_IMPORTED_MODULE_1___default().show({
...
window.addEventListener("access_code_generated", function (event) {
  node_snackbar__WEBPACK_IMPORTED_MODULE_1___default().show({
...
window.addEventListener("request_denied", function (event) {
  node_snackbar__WEBPACK_IMPORTED_MODULE_1___default().show({
...
window.addEventListener("file_deleted", function (event) {
  node_snackbar__WEBPACK_IMPORTED_MODULE_1___default().show({
